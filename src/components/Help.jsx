    ...
    return (
        <div className='parent-component'>
            ...
            <div className='faq'>
                ...
                <ul >
                    <li onClick={() => handleListClick(0)} className='outter-list'><span>How could I visit Meteora?</span><span className="material-symbols-outlined">add</span></li>
                    {activeIndex === 0 && (
                    ...
                    <li onClick={() => handleListClick(2)} className='outter-list'><span>Which is the nearest Monastery to the village?</span><span className="material-symbols-outlined">add</span></li>
                    {activeIndex === 2 && (<div className='dropdowns'><div><span className="material-symbols-outlined">church</span><span>The closest Monastery to Kastraki (about 2 km or 1.2 miles) is the Monastery of St. Nicholas Anapausas. Here is the map below where you could find directions:</span></div>
                        ...
                        {/* <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12274.797181536842!2d21.6247197!3d39.7239401!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13590fae0f2d615d%3A0x908f12f68ece6011!2zzpnOtc-BzqwgzpzOv869zq4gzpHOs86vzr_PhSDOnc65zrrOv867zqzOv8-FIM6Rzr3Osc-AzrHPhc-DzqwgzpzOtc-EzrXPjs-Bz4nOvQ!5e0!3m2!1sel!2sgr!4v1684848263413!5m2!1sel!2sgr"
                            width="400"
                            height="300"
                            style="border:0;"
                            allowfullscreen=""
                        ...
                        <div>You can find directions to the rest of the monasteries by following the links below:
                            <ul >
                                <li className='inner-list'><a href="https://goo.gl/maps/aj9kL5Y6tU8ZY9eo6?coh=178572&entry=tt" target='_blank' className='monastery-links'>The Monastery of Great Meteoron</a> (Spectacular view!)</li>
                                <li className='inner-list'><a href="https://goo.gl/maps/FWpMG7WbrpPytsKm9?coh=178572&entry=tt" target='_blank' className='monastery-links'>The Monastery of Saint Nicholas Anapausas</a> (Closest to Kastraki.)</li>
                                ...
                                <li className='inner-list'><a href="https://goo.gl/maps/bQcf2bsKZxmVyu3K9?coh=178572&entry=tt" target='_blank' className='monastery-links'>The Monastery of Holy Trinity</a></li>
                                <li className='inner-list'><a href='https://goo.gl/maps/wAaFCmZSipUwpfog8?coh=178572&entry=tt' target='_blank' className='monastery-links'>The Monastery of Saint Stephan</a></li>
                            </ul>
                        </div>
                    </div>)}
                    <li onClick={() => handleListClick(3)} className='outter-list'><span>Which is the bus schedule?</span><span className="material-symbols-outlined">add</span></li>
                    {activeIndex === 3 && (<div className='dropdowns'><div><span className="material-symbols-outlined">directions_bus</span><span>You could find information about the local bus schedule </span><a href='https://www.ktel-trikala.gr/?module=default&pages_id=45&lang=en' className='bus-schedule-link' target='_blank'>here</a>.</div></div>)}
                    <li onClick={() => handleListClick(1)} className='outter-list'><span>Which is the WiFi name and password?</span><span className="material-symbols-outlined">add</span></li>
                    {activeIndex === 1 && (<div className='dropdowns'><div><span className="material-symbols-outlined">wifi</span><span>The WiFi name is Marmaraki and the password is Marmaraki1515</span></div></div>)}
                    <li onClick={() => handleListClick(4)} className='outter-list'><span>What time is the check-out?</span><span className="material-symbols-outlined">add</span></li>
            ...
            <div className="contact">
                ...
                <ul className='bullet-list'>
                    <li>Phone: <a href={`tel:${6943120920}`}>{6943120920}</a> </li>
                    <li>E-mail: marmaraki.apartment@gmail.com       </li>
                </ul>
            </div>
        </div>
