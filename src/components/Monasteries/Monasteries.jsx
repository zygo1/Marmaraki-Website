...
const Monastery = ({ monastery, index }) => {
  ...
  return (
    <div
      className={`container monasteries ${isExpanded ? "expanded" : ""}`}
      key={index}
    >
      ...
      <div className="button-location">
        ...
        <button onClick={toggleInfo} className="info-button">
          {isExpanded ? "Hide information" : "See more information"}
        </button>
        <a
          href={monastery.link}
          target="_blank"
      ...
      {isExpanded ? (
        <article className="information">
          ...
          {monastery.hours.map((hour, index) => (
            <>
              <span key={index}>{hour}</span> <br />
            </>
          ))}
        </article>
      ) : null}
...
const Monasteries = () => {
  const monasteriesArr = [
    ...
    },
    {
      ...
      hours: [
        "Monday Closed",
        "Tuesday 9:00 - 13:30 and 15:30 - 17:30",
        "Wednesday 9:00 - 13:30 and 15:30 - 17:30",
        "Thursday 9:00 - 13:30 and 15:30 - 17:30",
        "Friday 9:00 - 13:30 and 15:30 - 17:30",
        "Saturday 9:00 - 13:30 and 15:30 - 17:30",
        "Sunday 9:00 - 13:30 and 15:30 - 17:30",
      ],
    },
  ];
    ...
    <>
      ...
      <section className="monasteries-wrapper">
        {monasteriesArr.map((monastery, index) => {
          return <Monastery key={index} monastery={monastery} />;
        })}
      </section>
      <ScrollToTop />
    </>
